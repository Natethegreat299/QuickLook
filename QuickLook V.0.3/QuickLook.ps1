Write-Host "=== QuickLook Starting ===" -ForegroundColor Green
...
New-HTMLHeader -Title "QuickLook - System Info" -HeaderText "QuickLook System Report" |
...
New-HTMLHeader -Title "QuickLook - Network Info" -HeaderText "QuickLook Network Report" |
...
New-HTMLHeader -Title "QuickLook - Security Info" -HeaderText "QuickLook Security Report" |
...
New-HTMLHeader -Title "QuickLook - Storage Info" -HeaderText "QuickLook Storage Report" |
...
New-HTMLHeader -Title "QuickLook - Installed Apps" -HeaderText "Installed Applications" |
